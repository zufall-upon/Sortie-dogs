...
```text
node test/fixtures/representative-medium/run-representative-rpt.mjs --prepare --runtime-root _testenv/representative-medium --package _testenv/sortie-dogs-0.9.0.tgz
```
