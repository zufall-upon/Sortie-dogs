...
function validateConfig(config) {
  ...
  invariant(isRecord(config.package) && typeof config.package.path === "string" &&
    config.package.version === "0.8.0" && SHA256.test(config.package.sha256), "Package provenance is invalid.");
...
export async function prepareRepresentativeRuntime({ runtimeRoot, packagePath }) {
  ...
  invariant(repositoryPackage.version === "0.8.0", "Representative fixture requires package version 0.8.0.");
