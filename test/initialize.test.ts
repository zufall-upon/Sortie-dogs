...
test("beta CLI defaults to namespaced preview assets", async () => {
  ...
  try {
    ...
    assert.equal(await readFile(join(project, ".opencode/sortie-dogs-v010.version"), "utf8"), "0.10.0-v0912-language4-cost-rpt10-compaction-ref1-proposal1-review-remediation1-surface3-proposal-recovery2-quality1-terminal1\n");
