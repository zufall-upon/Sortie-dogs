...
test("packed package exposes plugin and versioned runtime assets", async () => {
  ...
  try {
    ...
    assert.equal(
      ...
      "0.10.0-v0912-language4-cost-rpt10-compaction-ref1-proposal1-review-remediation1-surface3-proposal-recovery2-quality1-terminal1-route1\n",
    );
    ...
    assert.ok(loaded.previewAssets.every(asset => asset.version === "0.10.0-v0912-language4-cost-rpt10-compaction-ref1-proposal1-review-remediation1-surface3-proposal-recovery2-quality1-terminal1-route1"));
