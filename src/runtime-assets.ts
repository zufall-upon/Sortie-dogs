...
RUNTIME_ASSET_VERSION_SYNC_FIXTURE
    runtime_version: 0.3.4-card40
    shared_marker: src/asset-version.ts
    packaged_expectation: test/plugin-loader.test.ts uses 0.3.4-card40
    initialize_expectation: test/initialize.test.ts uses 0.3.4-card40
