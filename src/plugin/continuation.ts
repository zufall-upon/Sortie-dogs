...
const ROLLOVER_PROMPT = [
  ...
  "",
  "## 未達のユーザー要求",
  "- <acceptance criteriaを除く、まだ満たされていない明示要求>",
  "",
  "## task identity と制約",
  ...
  "",
  "## tracker batch state",
  "- inventoryFingerprint: <fingerprint> / candidateQueue: <bounded identity, status, ordering, implementation root, exact handoff path, and opaque acceptance fingerprint only>",
