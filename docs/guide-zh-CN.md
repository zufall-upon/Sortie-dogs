...
`dog-coordinator` 默认使用 `openai/gpt-5.6-terra` 的 `high` variant，`dog-scout` 默认使用 `openai/gpt-5.6-luna`。
...
[Release v0.5.10](https://github.com/zufall-upon/Sortie-dogs/releases/tag/v0.5.10)
